            ...
            <div className="flex flex-col 2xl:flex-row gap-4 mb-4">
              ...
              <div className="flex flex-col w-full">
                ...
                >
                  ...
                  <option value="Book for vacation">Book for vacation</option>
                  <option value="Charity support">Charity support</option>
                  <option value="Interview Request">Interview Request</option>
                  <option value="Meet and greet">Meet and greet</option>
                  <option value="Ask for retirement">Ask for retirement</option>
                </select>
              </div>
            </div>
        ...
        <div className="container place-self-center 2xl:mt-[-50px] xl:mt-[-180px] mt-8 xl:w-1/2 xl:text-center ml-[-100px] ">
          ...
          <ul className="mt-2 leading-loose tracking-tight text-base ">
            <li className="hover:text-red-500 cursor-pointer relative ">
              <IoTimeOutline className='absolute 2xl:top-[7px] 2xl:right-[320px] right-[18px] top-[8px]'/>Monday: 9am-6:00pm
            </li>
            <li className="hover:text-red-500 cursor-pointer relative ">
              <IoTimeOutline className='absolute 2xl:top-[7px] 2xl:right-[320px] right-[18px] top-[8px]'/>Tuesday: 9am-6:00pm
            </li>
            <li className="hover:text-red-500 cursor-pointer relative 2xl:ml-[22px] ">
              <IoTimeOutline className='absolute 2xl:top-[7px] 2xl:right-[320px] right-[18px] top-[8px]'/>Wednesday: 9am-6:00pm
            </li>
            <li className="hover:text-red-500 cursor-pointer relative 2xl:ml-[1px]">
              <IoTimeOutline className='absolute 2xl:top-[7px] 2xl:right-[320px] right-[18px] top-[8px]'/>Thursday: 9am-6:00pm
            </li>
            <li className="hover:text-red-500 cursor-pointer relative 2xl:ml-[-13px]">
              <IoTimeOutline className='absolute 2xl:xl:top-[7px] 2xl:right-[320px] right-[18px] top-[8px]'/>Friday: 9am-6:00pm
            </li>
          </ul>
        </div>
      </div>
